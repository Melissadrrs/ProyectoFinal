using Carrito.Repositories.Dapper.Carrito;
...
namespace Carrito.Mvc.App_Start
{
    public class DIConfig
    {
        public static void ConfigureInjector()
        {
            ...
            container.Register<IUnitOfWork>(() =>
                new CarritoUnitOfWork(ConfigurationManager.ConnectionStrings["CarritoConnection"].ToString()), Lifestyle.Scoped);
